...
function LoginScreen({ onLogin }) {
  ...
  const ls = {
    wrap: { minHeight: "100vh", background: "linear-gradient(135deg,#2d4a1e 0%,#3d5a2e 50%,#4a6e35 100%)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Jost', sans-serif" },
    ...
    title: { fontSize: "28px", fontWeight: "600", color: "#2d2a20", margin: "0 0 4px", fontFamily: "'Cormorant Garamond', serif", letterSpacing: "0.5px" },
    subtitle: { fontSize: "11px", color: "#8a8068", marginBottom: "28px", textTransform: "uppercase", letterSpacing: "2px", fontWeight: "500" },
    dotsRow: { display: "flex", justifyContent: "center", gap: "14px", marginBottom: "28px" },
    dot: (filled) => ({ width: "11px", height: "11px", borderRadius: "50%", background: filled ? "#3d5a2e" : "transparent", border: "2px solid #3d5a2e", transition: "background 0.15s" }),
    grid: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px", marginBottom: "16px" },
    btn: { background: "#f5f0e8", border: "1.5px solid #d4c9a8", borderRadius: "14px", padding: "16px", fontSize: "22px", fontWeight: "400", color: "#2d2a20", cursor: "pointer", fontFamily: "'Cormorant Garamond', serif", transition: "all 0.15s" },
    delBtn: { background: "#f5f0e8", border: "1.5px solid #d4c9a8", borderRadius: "14px", padding: "14px", fontSize: "15px", color: "#8a8068", cursor: "pointer", fontFamily: "'Jost', sans-serif" },
    error: { color: "#c0392b", fontSize: "11px", height: "18px", marginTop: "4px", letterSpacing: "0.5px", textTransform: "uppercase" },
  };
...
export default function App() {
  ...
  const s = {
    app: { minHeight: "100vh", background: "linear-gradient(135deg,#f5f0e8 0%,#e8f0e3 50%,#f0ede3 100%)", fontFamily: "'Jost', sans-serif", color: "#2d2a20" },
    ...
    headerTitle: { color: "#f5f0e0", fontSize: "22px", fontWeight: "600", margin: 0, display: "flex", alignItems: "center", gap: "10px", fontFamily: "'Cormorant Garamond', serif", letterSpacing: "0.5px" },
    ...
    logoutBtn: { background: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.3)", color: "#f5f0e0", borderRadius: "20px", padding: "5px 12px", fontSize: "12px", cursor: "pointer", fontFamily: "'Jost', sans-serif" },
    nav: { display: "flex", gap: "4px", padding: "10px 20px", background: "#f5f0e0", borderBottom: "2px solid #d4c9a8", overflowX: "auto" },
    navBtn: (a) => ({ padding: "7px 14px", borderRadius: "20px", border: "none", background: a ? "#3d5a2e" : "transparent", color: a ? "#f5f0e0" : "#3d5a2e", fontFamily: "'Jost', sans-serif", fontSize: "13px", cursor: "pointer", whiteSpace: "nowrap", fontWeight: a ? "bold" : "normal" }),
    ...
    summaryLabel: { fontSize: "10px", color: "#5a7040", textTransform: "uppercase", letterSpacing: "1.5px", fontWeight: "500" },
    summaryValue: { fontSize: "22px", fontWeight: "600", color: "#3d5a2e", fontFamily: "'Cormorant Garamond', serif" },
    ...
    productName: { fontWeight: "500", fontSize: "15px", flex: 1, minWidth: "130px", letterSpacing: "0.2px" },
    ...
    priceLabel: { fontSize: "9px", color: "#888", textTransform: "uppercase", letterSpacing: "1px", fontWeight: "500" },
    priceValue: (a) => ({ fontSize: "17px", fontWeight: "600", color: a, fontFamily: "'Cormorant Garamond', serif" }),
    ...
    stockNum: (p) => ({ fontSize: "20px", fontWeight: "600", color: stockColor(p), fontFamily: "'Cormorant Garamond', serif" }),
    actionBtn: (c) => ({ background: c, color: "#fff", border: "none", borderRadius: "8px", padding: "5px 11px", cursor: "pointer", fontFamily: "'Jost', sans-serif", fontSize: "13px" }),
    input: { border: "1.5px solid #c4b98a", borderRadius: "8px", padding: "5px 9px", fontFamily: "'Jost', sans-serif", fontSize: "13px", background: "#fffdf5", color: "#2d2a20", width: "72px" },
    select: { border: "1.5px solid #c4b98a", borderRadius: "8px", padding: "5px 8px", fontFamily: "'Jost', sans-serif", fontSize: "12px", background: "#fffdf5", color: "#2d2a20" },
    sectionTitle: { fontSize: "18px", fontWeight: "600", color: "#3d5a2e", marginBottom: "10px", display: "flex", alignItems: "center", gap: "8px", fontFamily: "'Cormorant Garamond', serif", letterSpacing: "0.3px" },
    searchInput: { width: "100%", border: "1.5px solid #c4b98a", borderRadius: "24px", padding: "9px 18px", fontFamily: "'Jost', sans-serif", fontSize: "14px", background: "rgba(255,255,255,0.8)", color: "#2d2a20", marginBottom: "14px", boxSizing: "border-box" },
    ...
    fullInput: { width: "100%", border: "1.5px solid #c4b98a", borderRadius: "8px", padding: "8px 12px", fontFamily: "'Jost', sans-serif", fontSize: "14px", background: "#fffdf5", color: "#2d2a20", boxSizing: "border-box" },
    primaryBtn: { background: saving ? "#aaa" : "linear-gradient(90deg,#3d5a2e,#5a7a3a)", color: "#f5f0e0", border: "none", borderRadius: "24px", padding: "11px 28px", fontFamily: "'Jost', sans-serif", fontSize: "15px", cursor: saving ? "not-allowed" : "pointer", fontWeight: "bold", width: "100%", marginTop: "6px" },
    ...
    loadingWrap: { minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg,#f5f0e8,#e8f0e3)", fontFamily: "'Jost', sans-serif", color: "#3d5a2e", fontSize: "18px" },
  };
